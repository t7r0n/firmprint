...
PROJECT_DIRECTION = 'An open source tool that ingests a fund\'s historical memo and deal-review corpus and emits a machine readable "firm profile" - screening criteria, IC memo style guide, decision bias matrix - that drops directly into Firmprint\'s Analyst and Memo agents as a system prompt + few shot bundle.'
